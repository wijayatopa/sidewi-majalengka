...
<head>
    ...
    <!-- DataTables CSS -->
    <link href="<?php echo base_url(); ?>assets/back-end/vendor/datatables-plugins/dataTables.bootstrap.css" rel="stylesheet">

    <!-- DataTables Responsive CSS -->
    <link href="<?php echo base_url(); ?>assets/back-end/vendor/datatables-responsive/dataTables.responsive.css" rel="stylesheet">
