...
echo form_open_multipart('wisata/add',$atribut);
 ?>
        ...
        <div class="col-sm-12">
            ...
            <input name="nama_wisata" type="text" class="form-control" placeholder="Nama Wisata" value="<?php echo set_value('nama_wisata'); ?>" required>
        </div>
    	</div>
        ...
        <div class="col-sm-12">
            ...
            <input name="tiket" type="text" class="form-control" placeholder="Tiket" value="<?php echo set_value('tiket'); ?>" required>
        </div>
    	</div> 
